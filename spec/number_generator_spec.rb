...
#END ONES
  ...
  it ("returns word form of value for arrays holding numbers ten through fifteen") do
    expect(12.translate()).to(eq(["twelve"]))
  end
  it ("returns word form of value for arrays holding numbers sixteen through nineteen") do
